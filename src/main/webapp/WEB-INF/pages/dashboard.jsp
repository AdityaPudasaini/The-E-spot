...
<html>
    ...
    <body style="margin-top:0">
        ...
        <div id="mainWrapper" style="display: flex; flex-direction: column; margin-left: 250px; width: calc(100% - 250px); margin-top: 0">

            <div class="userTopBar" style="margin-top:0">
            ...
            <div id="bottomGrid" style="display: flex; gap: 20px; padding: 0 30px 30px 30px;">
